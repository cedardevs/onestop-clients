...
def handler(key, value):
    ...
    try:
        ...
        content_dict['discovery']['dsmmAccessibility'], content_dict['discovery']['dsmmDataIntegrity'], \
        content_dict['discovery']['dsmmDataQualityAssessment'], content_dict['discovery']['dsmmDataQualityAssurance'], \
        content_dict['discovery']['dsmmDataQualityControlMonitoring'], content_dict['discovery'][
            'dsmmPreservability'] = 0, 0, 0, 0, 0, 0
        content_dict['discovery']['dsmmProductionSustainability'], content_dict['discovery'][
            'dsmmTransparencyTraceability'], content_dict['discovery']['dsmmUsability'], content_dict['discovery'][
            'dsmmAverage'] = 0, 0, 0, 0.0
